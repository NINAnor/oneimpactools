...
scenario_table_create <- function(s_gid = 1,
                                  ...
                                  sub_area = NA,
                                  species = NA,
                                  intra_inter_season = c("intra", "inter")[1],
                                  season = NA,
                                  season_suit_s = NA,
                                  season_suit_t = NA,
                                  season_perm = NA,
                                  ...
                                  modified_var_names_suit_s = NA,
                                  modified_var_names_suit_t = NA,
                                  modified_var_names_perm = NA,
                                  zoi_radii_suit_s = NA,
                                  zoi_radii_suit_t = NA,
                                  zoi_radii_perm = NA,
                                  baseline_max_suit_s = NA,
                                  baseline_max_suit_t = NA,
  ...
  tb <- data.frame(s_gid = s_gid,
                   ...
                   season = season,
                   season_suit_s = season_suit_s,
                   season_suit_t = season_suit_t,
                   season_perm = season_perm,
                   baseline = baseline,
                   ...
                   modified_var_names_suit_s = modified_var_names_suit_s,
                   modified_var_names_suit_t = modified_var_names_suit_t,
                   modified_var_names_perm = modified_var_names_perm,
                   zoi_radii_suit_s = zoi_radii_suit_s,
                   zoi_radii_suit_t = zoi_radii_suit_t,
                   zoi_radii_perm = zoi_radii_perm,
                   baseline_max_suit_s = baseline_max_suit_s,
                   baseline_max_suit_t = baseline_max_suit_t,
