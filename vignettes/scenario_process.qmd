...
scen_tab_fil <- "../03_output/scenarios_mdir_2023_tiltak_rondane_ss1.rds"
...
for(i in seq_along(scenario_output_plot)) {
  ...
  for(j in 1:terra::nlyr(scenario_output_plot[[i]])) {
    ...
    # save
    f_name <- paste0(dir, "scenario_", name, "_", ly, ".tif")
...
summ_tab |> 
  ...
  write.csv(file = "../03_output/final_maps/summary_table.csv", row.names = FALSE)
```
